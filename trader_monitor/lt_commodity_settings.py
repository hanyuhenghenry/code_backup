...
symbol_lists = {'zce': ['AP', 'CF', 'CJ', 'FG', 'MA', 'OI', 'RM', 'SA', 'SF', 'SM', 'SR', 'TA', 'UR', 'ZC', 'PF', 'PK'],
                    ...
                    'shfe': ['ag', 'au', 'al', 'bu', 'cu', 'fu', 'hc', 'ni', 'pb', 'rb', 'ru', 'sn', 'sp', 'ss', 'zn', 'lu', 'sc']}


list_ferrous=['rb','hc','i','j','jm','SM','SF','SA','FG']
list_base=['cu','al','zn','pb','ni','sn']
list_petchem=['ru','sc','fu','bu','l','pp','v','MA','TA','PF','eb','eg','pg']
list_ags=['jd','SR','CF','m','c','y','p','OI','a']
list_others=['UR','CJ','AP','sp']
list_live = list_ferrous+list_base+list_petchem+list_ags+list_others